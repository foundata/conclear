"""Candidate publication and signing services.

Verification of the attested candidate lives in
`conclear.services.verification` and promotion of the verified digest in
`conclear.services.promotion`.
"""
